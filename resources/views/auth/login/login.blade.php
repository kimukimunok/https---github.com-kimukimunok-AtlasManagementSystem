...
<body>
    <form action="{{ route('loginPost') }}" method="POST">
        <div class="login-background w-100 vh-100 d-flex flex-column" style="align-items:center; justify-content:center;">
            <!-- 上のクラスをd-flexの後に flex-column を追加することで、配置を横から縦にすることができる。-->
            <!-- このあたりに画像を表示させる。 -->
            <div>
                <img class="Atlas-image" src="{{ asset('image/atlas-black.png')}}" alt="">
            </div>
            <div class="calendar_common login_area  vh-50">
                ...
                <div class="login_new text-center">
